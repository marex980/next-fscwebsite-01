    ...
    // <main className="2xl:max-w-[1600px] container-wrapper m-inline-auto overflow-x-hidden">
      ...
      <div className="">
        <motion.div
          ...
          className="pt-[2em] pb-0 px-[2em] flex flex-col relative origin-[center_top] transition-all duration-[0.3s] ease-linear delay-[0.4s] max-w-[1600px] justify-between m-inline-auto text-center gap-4 overflow-hidden min-h-screen"
        >
